...
public class RoutineService {
	...
	*/
	@Transactional
	public Routine addRoutine(RoutineRequest request){
	...
	public List<Routine> getRoutinesByDate(Long memberId, LocalDate date) {
		return routineRepository.findByMemberIdAndDate(memberId, date);
	}
